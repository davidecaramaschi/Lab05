...
def main(page: ft.Page):
    ...
    def aggiungi_auto(e):
        try:
            ...
            if marca == "" or modello == "":
                alert.show_alert("❌ Inserisci tutti i campi richiesti")
                return
    ...
    pulsante_aggiorna_lista = ft.ElevatedButton("Aggiorna lista", on_click=aggiorna_lista)
